function Materialloader () {
    ...
    var materials = {
        15:   { main: { tex: '018', normal: 'empty_normal' }, top: { tex: '018', normal: 'empty_normal' }, descr: 'pipette', transparent: true, opacity: 0.5 },
        0:    { main: { tex: '000', normal: 'empty_normal' }, top: { tex: '000', normal: 'empty_normal' }, descr: 'air', transparent: true, opacity: 0.5 },
        1:    { main: { tex: '001', normal: 'empty_normal' }, top: { tex: '001', normal: 'empty_normal' }, descr: 'sand1', transparent: false, opacity: 1 },
        2:    { main: { tex: '002', normal: 'empty_normal' }, top: { tex: '002', normal: 'empty_normal' }, descr: 'sand2', transparent: false, opacity: 1 },
